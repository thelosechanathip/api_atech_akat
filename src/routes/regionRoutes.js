...
router.post('/getDistrictByProvinceId/:id', authCheckAdmin, getDistrictsDataByProvinceId);
...
router.post('/getSubDistrictByDistrictId/:id', authCheckAdmin, getSubDistrictsDataByDistrictId);
